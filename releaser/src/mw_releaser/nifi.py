...
# Configuration
VERSION_FILE = "images/nifi/VERSION.txt"
IMAGE_NAME = "nifi"
RELEASED_VERSION_FILE = "images/nifi/RELEASED_VERSION.txt"


class NifiReleaser(BaseReleaser):
    ...
    def prep(self, version=None):
        ...
        print(f"Preparing NiFi release {version} ...")
    ...
    def push(self, version=None):
        ...
        if new_image_released:
            print(f"Pushing NiFi container images for version {version} ...")
            self.run_command(
