...
# Configuration
VERSION_FILE = "images/airflow/VERSION.txt"
IMAGE_NAME = "airflow"
RELEASED_VERSION_FILE = "images/airflow/RELEASED_VERSION.txt"


class AirflowReleaser(BaseReleaser):
    ...
    def prep(self, version=None):
        ...
        print(f"Preparing Airflow release {version} ...")
    ...
    def push(self, version=None):
        ...
        if new_image_released:
            print(f"Pushing Airflow container images for version {version} ...")
            self.run_command(
