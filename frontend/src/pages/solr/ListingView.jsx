...
const ListingView = ({
    ...
    const { platforms, loading, fetchPlatforms, getPlatformState, deletePlatform } = solr;
    ...
    return (
        <GenericListingView
            title="Solr"
            description="Manage indexing and search with Apache Solr"
            items={platforms}
            loading={loading}
            ...
            createConfig={{
                title: "Provision Solr",
                buttonText: "NEW SOLR",
            }}
            searchPlaceholder="Search Solr instances..."
            emptyState={{
                title: "No Solr instances found",
                description: selectedProject ? `No Solr instances in ${selectedProject.name}.` : 'Create your first Solr instance to get started.',
            ...
            deleteModalConfig={{
                title: "Delete Solr",
                message: "Are you sure you want to decommission this Solr instance? This will permanently delete the metadata and associated resources."
            }}
            darkMode={darkMode}
