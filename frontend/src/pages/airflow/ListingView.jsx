...
const ListingView = ({ darkMode, selectedProject, onSelectPlatform, airflow }) => {
    const { platforms, loading, fetchPlatforms, getPlatformState, deletePlatform } = airflow;
    ...
    return (
        <GenericListingView
            ...
            createConfig={{
                title: "Provision Airflow Instance",
                buttonText: "NEW INSTANCE",
            }}
            searchPlaceholder="Search Airflow instances..."
            emptyState={{
                title: "No instances found",
                description: selectedProject ? `No Airflow instances in ${selectedProject.name}.` : 'Create your first Airflow instance to get started.',
                icon: <Activity size={48} className="text-slate-700" />
            }}
            renderSubtitle={renderSubtitle}
            renderBadges={renderBadges}
            deleteModalConfig={{
                title: "Delete Airflow Instance",
                message: "Are you sure you want to delete this Airflow instance? This will permanently remove all associated resources."
            }}
            darkMode={darkMode}
