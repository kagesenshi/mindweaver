...
const LoginPage = () => {
    ...
    const fetchFeatureFlags = async () => {
        ...
        try {
            ...
            const enabled = data.oidc_enabled ?? false;
                                ...
                                oidcEnabled && (
                                    <>
                                        <button
                                            ...
                                            onClick={() => login()}
                                            className="w-full bg-slate-800/60 hover:bg-slate-700/60 border border-slate-700/60 text-white font-bold py-4 rounded-2xl flex items-center justify-center gap-3 transition-all active:scale-[0.98] group mb-6"
                                        >
