...
export const useRanger = () => {
    ...
    const fetchPlatforms = useCallback(async () => {
        setLoading(true);
        try {
            const response = await apiClient.get('/platform/ranger');
            setPlatforms(response.data.data || []);
        } catch (err) {
            setError(err);
        } finally {
    ...
    const createPlatform = useCallback(async (data) => {
        const response = await apiClient.post('/platform/ranger', data);
        await fetchPlatforms();
        return response.data;
    }, [fetchPlatforms]);

    const updatePlatformState = useCallback(async (id, state, headers = {}) => {
        const response = await apiClient.post(`/platform/ranger/${id}/_state`, state, { headers });
        await fetchPlatforms();
        return response.data;
    }, [fetchPlatforms]);

    const deletePlatform = useCallback(async (id, confirmName) => {
        await apiClient.delete(`/platform/ranger/${id}`, {
            headers: { 'X-RESOURCE-NAME': confirmName }
        });
        await new Promise(resolve => setTimeout(resolve, 500));
        await fetchPlatforms();
    ...
    const getPlatformState = useCallback(async (id) => {
        const response = await apiClient.get(`/platform/ranger/${id}/_state`);
        return response.data;
    }, []);

    const refreshPlatformState = useCallback(async (id) => {
        const response = await apiClient.post(`/platform/ranger/${id}/_refresh`);
        return response.data;
    }, []);

    const fetchActions = useCallback(async (id) => {
        const response = await apiClient.get(`/platform/ranger/${id}/_actions`);
        return response.data.actions || [];
    }, []);

    const executeAction = useCallback(async (id, action, parameters = {}) => {
        const response = await apiClient.post(`/platform/ranger/${id}/_actions`, { action, parameters });
        return response.data;
    }, []);
...
export const useOpenSearch = () => {
    ...
    const fetchPlatforms = useCallback(async () => {
        setLoading(true);
        try {
            const response = await apiClient.get('/platform/opensearch');
            setPlatforms(response.data.data || []);
        } catch (err) {
            setError(err);
        } finally {
    ...
    const createPlatform = useCallback(async (data) => {
        const response = await apiClient.post('/platform/opensearch', data);
        await fetchPlatforms();
        return response.data;
    }, [fetchPlatforms]);

    const updatePlatformState = useCallback(async (id, state, headers = {}) => {
        const response = await apiClient.post(`/platform/opensearch/${id}/_state`, state, { headers });
        await fetchPlatforms();
        return response.data;
    }, [fetchPlatforms]);

    const deletePlatform = useCallback(async (id, confirmName) => {
        await apiClient.delete(`/platform/opensearch/${id}`, {
            headers: { 'X-RESOURCE-NAME': confirmName }
        });
        await new Promise(resolve => setTimeout(resolve, 500));
        await fetchPlatforms();
    ...
    const getPlatformState = useCallback(async (id) => {
        const response = await apiClient.get(`/platform/opensearch/${id}/_state`);
        return response.data;
    }, []);

    const refreshPlatformState = useCallback(async (id) => {
        const response = await apiClient.post(`/platform/opensearch/${id}/_refresh`);
        return response.data;
    }, []);

    const fetchActions = useCallback(async (id) => {
        const response = await apiClient.get(`/platform/opensearch/${id}/_actions`);
        return response.data.actions || [];
    }, []);

    const executeAction = useCallback(async (id, action, parameters = {}) => {
        const response = await apiClient.post(`/platform/opensearch/${id}/_actions`, { action, parameters });
        return response.data;
    }, []);
...
export const useSolr = () => {
    ...
    const fetchPlatforms = useCallback(async () => {
        setLoading(true);
        try {
            const response = await apiClient.get('/platform/solr');
            setPlatforms(response.data.data || []);
        } catch (err) {
            setError(err);
        } finally {
    ...
    const createPlatform = useCallback(async (data) => {
        const response = await apiClient.post('/platform/solr', data);
        await fetchPlatforms();
        return response.data;
    }, [fetchPlatforms]);

    const updatePlatformState = useCallback(async (id, state, headers = {}) => {
        const response = await apiClient.post(`/platform/solr/${id}/_state`, state, { headers });
        await fetchPlatforms();
        return response.data;
    }, [fetchPlatforms]);

    const deletePlatform = useCallback(async (id, confirmName) => {
        await apiClient.delete(`/platform/solr/${id}`, {
            headers: { 'X-RESOURCE-NAME': confirmName }
        });
        await new Promise(resolve => setTimeout(resolve, 500));
        await fetchPlatforms();
    ...
    const getPlatformState = useCallback(async (id) => {
        const response = await apiClient.get(`/platform/solr/${id}/_state`);
        return response.data;
    }, []);

    const refreshPlatformState = useCallback(async (id) => {
        const response = await apiClient.post(`/platform/solr/${id}/_refresh`);
        return response.data;
    }, []);

    const fetchActions = useCallback(async (id) => {
        const response = await apiClient.get(`/platform/solr/${id}/_actions`);
        return response.data.actions || [];
    }, []);

    const executeAction = useCallback(async (id, action, parameters = {}) => {
        const response = await apiClient.post(`/platform/solr/${id}/_actions`, { action, parameters });
        return response.data;
    }, []);
