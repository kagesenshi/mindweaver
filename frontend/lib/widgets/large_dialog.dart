...
class LargeDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final reducedTextTheme = theme.textTheme.apply(fontSizeDelta: -2);

    return Theme(
      data: theme.copyWith(
        textTheme: reducedTextTheme,
        inputDecorationTheme: theme.inputDecorationTheme.copyWith(
          ...
          labelStyle: reducedTextTheme.bodyMedium?.copyWith(
            color: isDark ? Colors.white70 : Colors.grey.shade700,
          ),
          hintStyle: reducedTextTheme.bodyMedium?.copyWith(
            color: isDark ? Colors.white30 : Colors.grey.shade400,
          ),
          floatingLabelStyle: reducedTextTheme.bodyMedium?.copyWith(
            color: accentColor,
          ),
        ),
      ),
            ...
            children: [
              Row(
                ...
                children: [
                  Text(
                    title,
                    style: reducedTextTheme.headlineMedium?.copyWith(
